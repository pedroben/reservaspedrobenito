...
public class filtroAutenticacion implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            HttpSession oSession = ((HttpServletRequest) request).getSession();
            UsuarioBean oUsuarioBean = (UsuarioBean) oSession.getAttribute("usuarioBean");
            if (oUsuarioBean == null)//no hay sesión
            {
                ...
                //httpResponse.sendRedirect("/Controller?class=usuario&method=login");
                HttpServletRequest http = (HttpServletRequest) request;
                RequestDispatcher disp = http.getRequestDispatcher("/forbidden.html");
